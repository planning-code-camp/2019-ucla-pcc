...
venue: "UCLA - Planning Code Camp"        # brief name of host site without address (e.g., "Euphoric State University")
address: "West Classroom, Room 23167, Young Research Library"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
instructor: ["Leigh Phan", "Kristian Allen", "Tim Dennis"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jamie Jamison"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["datascience@ucla.edu", "cassie.halls@gmail.com"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes:  https://pad.carpentries.org/2019-ucla-pcc     # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: 54246034349          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
<p><a href="https://goo.gl/forms/gdwXGivkbXTO97CR2">https://goo.gl/forms/gdwXGivkbXTO97CR2</a></p>
...
<ul>
<li><a href="https://ucla-data-archive.github.io/intro-r-tidyv/">R via the Tidyverse</a>  - a lesson set using the tidyverse </li>
<li>Includes lessons developed with transit data based on Moderndive</li>
  <ul>
  <li><a href="https://ucla-data-archive.github.io/intro-r-tidyv/05-visualization/index.html">Data Visualization via ggplot2 - Transit data</a> </li>
  <li><a href="https://ucla-data-archive.github.io/intro-r-tidyv/05-reliability-dataprep/index.html">Reliability Data Preparation</a></li>
  <li><a href="https://ucla-data-archive.github.io/intro-r-tidyv/07-reliability-dataprep/index.html">Reliability Data Preparation</a></li>
  <li><a href="https://ucla-data-archive.github.io/intro-r-tidyv/09-ridership-append-files/index.html">Append csv Files into One Dataframe</a></li>
  </ul>
</ul>
